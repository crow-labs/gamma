...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/crow-labs/gamma/market/order
   */
  queryOrderAll = (
    query?: {
    ...
    this.request<MarketQueryAllOrderResponse, RpcStatus>({
      path: `/crow-labs/gamma/market/order`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/crow-labs/gamma/market/order/{orderId}/{buyerId}
   */
  queryOrder = (orderId: string, buyerId: string, params: RequestParams = {}) =>
    this.request<MarketQueryGetOrderResponse, RpcStatus>({
      path: `/crow-labs/gamma/market/order/${orderId}/${buyerId}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/crow-labs/gamma/market/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<MarketQueryParamsResponse, RpcStatus>({
      path: `/crow-labs/gamma/market/params`,
      method: "GET",
      format: "json",
      ...params,
    });
