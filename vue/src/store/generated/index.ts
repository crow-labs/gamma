...
import CrowLabsGammaCrowlabsGammaEscrow from './crow-labs/gamma/crowlabs.gamma.escrow'
import CrowLabsGammaCrowlabsGammaMarket from './crow-labs/gamma/crowlabs.gamma.market'
import CrowLabsGammaCrowlabsGammaWhitelist from './crow-labs/gamma/crowlabs.gamma.whitelist'
...
export default { 
  ...
  CrowLabsGammaCrowlabsGammaEscrow: load(CrowLabsGammaCrowlabsGammaEscrow, 'crowlabs.gamma.escrow'),
  CrowLabsGammaCrowlabsGammaMarket: load(CrowLabsGammaCrowlabsGammaMarket, 'crowlabs.gamma.market'),
  CrowLabsGammaCrowlabsGammaWhitelist: load(CrowLabsGammaCrowlabsGammaWhitelist, 'crowlabs.gamma.whitelist'),
