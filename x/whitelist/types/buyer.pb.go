...
func (*Buyer) Descriptor() ([]byte, []int) {
	return fileDescriptor_aea94ae1e5bf3227, []int{0}
}
...
func (m *Buyer) GetOrderIds() []string {
	if m != nil {
		return m.OrderIds
	}
	return nil
...
func init() {
	proto.RegisterType((*Buyer)(nil), "crowlabs.gamma.whitelist.Buyer")
}

func init() { proto.RegisterFile("whitelist/buyer.proto", fileDescriptor_aea94ae1e5bf3227) }

var fileDescriptor_aea94ae1e5bf3227 = []byte{
	// 177 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *Buyer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Status) > 0 {
		...
		i = encodeVarintBuyer(dAtA, i, uint64(len(m.Status)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.OrderIds) > 0 {
		for iNdEx := len(m.OrderIds) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintBuyer(dAtA, i, uint64(len(m.OrderIds[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
