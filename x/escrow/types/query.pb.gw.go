...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crow-labs", "gamma", "escrow", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Crow_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"crow-labs", "gamma", "escrow", "crow", "listingId", "orderId"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_CrowAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crow-labs", "gamma", "escrow", "crow"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Vote_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"crow-labs", "gamma", "escrow", "vote", "voterId", "disputeId"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_VoteAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crow-labs", "gamma", "escrow", "vote"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Dispute_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"crow-labs", "gamma", "escrow", "dispute", "crowId"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_DisputeAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crow-labs", "gamma", "escrow", "dispute"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Verdict_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"crow-labs", "gamma", "escrow", "verdict", "crowId", "disputeId"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_VerdictAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"crow-labs", "gamma", "escrow", "verdict"}, "", runtime.AssumeColonVerbOpt(true)))
)
